/**
 * [ClearEnemy.java]
 * Represents an enemy that shoots in a circle
 * @author Edison Du
...
class ClearGunEnemy extends Enemy {
   ...
   */
  ClearGunEnemy (int x, int y, int width, int height, int health, int speed, int range, int movementRange, int fireRate, int bulletSpeed) {
    super(x, y, width, height, health, speed, range, movementRange, fireRate, bulletSpeed);
    this.setGun(new ClearGun(x-5, y-5, 60, 60, fireRate, bulletSpeed,10));
  }
  ...
  public static void loadSprite() {
    sprite = loadSprite("Sprites/enemy-4.png");
  }
