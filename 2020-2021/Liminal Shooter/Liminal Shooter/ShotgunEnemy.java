/**
 * [ShotgunEnemy.java]
 * Represents an enemy that shoots many bullets in a cone
 * @author Edison Du
...
class ShotgunEnemy extends Enemy {
   ...
   */  
  ShotgunEnemy (int x, int y, int width, int height, int health, int speed, int range, int movementRange, int fireRate, int bulletSpeed) {
    super(x, y, width, height, health, speed, range, movementRange, fireRate, bulletSpeed);
    this.setGun(new Shotgun(x-5, y-5, 60, 60, fireRate, bulletSpeed));
  }
  ...
  public static void loadSprite() {
    sprite = loadSprite("Sprites/enemy-2.png");
  }
